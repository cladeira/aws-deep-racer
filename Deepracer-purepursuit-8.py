def reward_function(params):
    ...
    if distance_from_center <= marker_1:
        ...
        reward = -1 * (speed / 2)  # likely crashed/ close to off track / slow down!
    ...
    #Calculate the predicted vehicle location considering the current yaw angle.
    ...
    if predicted_distance <= marker_1: #vehicle is pointing to the right direction. 
        ...
        reward = -1 * ((predicted_distance / (distance * 2)) * (speed / 2))
        
    print('Reward:', reward,', Distance:', distance,', LocationDiff:', predicted_distance, ', P_X', P_X, 'P_Y', P_Y, 'C_X', C_X, 'C_Y', C_Y,', Yaw:', yaw,', Steering:', steering, 'Speed:', speed)
